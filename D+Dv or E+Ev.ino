...
int leftSensorValue, rightSensorValue, leftSensorValueb, rightSensorValueb;                      //variables for storing the value of the line sensors
...
void loop() {
  ...
  error = (leftSensorValueb + leftSensorValue) - (rightSensorValueb + rightSensorValue);                   //Calculate the error (difference between the two sensor values)
